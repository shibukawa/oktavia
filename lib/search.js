 ...
 */
function Search$I(entriesPerPage) {
	this._queries = null;
	this._result = null;
 ...
 */
function Search$ILStemmer$(entriesPerPage, stemmer) {
	this._queries = null;
	this._result = null;
	this._proposals = null;
	this._currentFolderDepth = 0;
...
Search$ILStemmer$.prototype = new Search;

/**
 * @param {!string} index
 */
Search.prototype.loadIndex$S = function (index) {
	this._oktavia = new Oktavia$();
	if (this._stemmer) {
		this._oktavia.setStemmer$LStemmer$(this._stemmer);
	}
	...
	if (this._queryString) {
		this.search$SF$IIV$((function (v) {
			if (! (v != null)) {
				debugger;
				throw new Error("[tool/web/search.jsx:81:28] null access\n            this.search(this._queryString, this._callback);\n                            ^\n");
			}
			return v;
 ...
 * @param {*} callback
 */
Search.prototype.search$SF$IIV$ = function (queryString, callback) {
 ...
 * @return {!number}
 */
Search.prototype.resultSize$ = function () {
 ...
 * @return {!number}
 */
Search.prototype.totalPages$ = function () {
 ...
 * @return {!number}
 */
Search.prototype.currentPage$ = function () {
 ...
 * @param {!number} page
 */
Search.prototype.setCurrentPage$I = function (page) {
 ...
 * @return {!boolean}
 */
Search.prototype.hasPrevPage$ = function () {
...
Search.prototype.getResult$ = function () {
	...
	last = this._currentPage * this._entriesPerPage;
	...
	for (i = start; i < last; i++) {
		...
		if (content.indexOf((function (v) {
			if (! (v != null)) {
				debugger;
				throw new Error("[tool/web/search.jsx:165:36] null access\n            if (content.indexOf(info[0]) == 1)\n                                    ^\n");
			}
			return v;
		}(info[0]))) === 1) {
		...
		results.push(new _Result$SSSI((function (v) {
			if (! (v != null)) {
				debugger;
				throw new Error("[tool/web/search.jsx:201:41] null access\n            results.push(new _Result(info[0], info[1], text, unit.score));\n                                         ^\n");
			}
			return v;
		}(info[0])), (function (v) {
			if (! (v != null)) {
				debugger;
				throw new Error("[tool/web/search.jsx:201:50] null access\n            results.push(new _Result(info[0], info[1], text, unit.score));\n                                                  ^\n");
			}
			return v;
 ...
 */
Search.prototype.getProposals$ = function () {
	/** @type {Style} */
	var style;
 ...
 */
Search.prototype._sortResult$LSearchSummary$ = function (summary) {
	/** @type {!number} */
	var i;
	/** @type {!number} */
	var score;
...
var $__jsx_classMap = {
	"tool/web/search.jsx": {
		...
		Search: Search,
		Search$I: Search$I,
		Search$ILStemmer$: Search$ILStemmer$
	},
	"src/oktavia.jsx": {
		Oktavia: Oktavia,
		Oktavia$: Oktavia$
...
function $__jsx_onload (event) {
	...
	JSX.runMain("tool/web/search.jsx", [])
}
