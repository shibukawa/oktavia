...
OktaviaSearch.prototype.getResult$ = function () {
	...
	for (i = start; i < last; i++) {
		...
		if (content.indexOf((function (v) {
			if (! (v != null)) {
				debugger;
				throw new Error("[tool/web/oktavia-search.jsx:175:36] null access\n            if (content.indexOf(info[0]) == 1)\n                                    ^\n");
			}
			return v;
		}(info[0]))) === 1) {
		...
		results.push(new _Result$SSSI((function (v) {
			if (! (v != null)) {
				debugger;
				throw new Error("[tool/web/oktavia-search.jsx:211:41] null access\n            results.push(new _Result(info[0], info[1], text, unit.score));\n                                         ^\n");
			}
			return v;
		}(info[0])), (function (v) {
			if (! (v != null)) {
				debugger;
				throw new Error("[tool/web/oktavia-search.jsx:211:50] null access\n            results.push(new _Result(info[0], info[1], text, unit.score));\n                                                  ^\n");
			}
			return v;
