// generatedy by JSX compiler 0.9.11 (2013-03-08 14:25:46 +0900; f02b3e07fd5a16f2eae7adb28276b7a6227c1cf2)
var JSX = {};
(function (JSX) {
/**
...
SAXParser.prototype.parse$S = function (chunk) {
	...
	/** @type {!string} */
	var comment$0;
	_ = ({whitespace: this._charClass$S("\r\n\t "), number: this._charClass$S("0124356789"), letter: this._charClass$S("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"), quote: this._charClass$S("'\""), entity: this._charClass$S("0124356789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ#"), attribEnd: this._charClass$S("\r\n\t >"), nameStart: /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, nameBody: /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040\.\d-]/, CDATA: "[CDATA[", DOCTYPE: "DOCTYPE", XML_NAMESPACE: "http://www.w3.org/XML/1998/namespace"});
	if (this.error) {
		throw this.error;
	}
	if (this.closed) {
	...
	while (this.c = c = chunk.charAt(i++)) {
		...
		case 2:
			...
			if (c === "<") {
				...
				if (Char$not$LChar$HBS(_, _.whitespace, c) && (! this.sawRoot || this.closedRoot)) {
		...
		case 18:
			...
			continue;
		case 19:
			if (! this.procInstBody && Char$is$LChar$HBS(_, _.whitespace, c)) {
				continue;
			} else {
				if (c === "?") {
					this.state = 20;
...
function Char$() {
	...
	this.whitespace = Char$_charClass$LChar$S(this, "\r\n\t ");
	this.number = Char$_charClass$LChar$S(this, "0124356789");
	this.letter = Char$_charClass$LChar$S(this, "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ");
	this.quote = Char$_charClass$LChar$S(this, "'\"");
	this.entity = Char$_charClass$LChar$S(this, "0124356789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ#");
	this.attribEnd = Char$_charClass$LChar$S(this, "\r\n\t >");
 ...
 */
Char._charClass$LChar$S = function ($this, str) {
	/** @type {Object.<string, undefined|!boolean>} */
	var result;
	/** @type {!number} */
	var i;
...
var Char$_charClass$LChar$S = Char._charClass$LChar$S;
 ...
 * @return {!boolean}
 */
Char.is$LChar$LRegExp$S = function ($this, charclass, c) {
	return charclass.test(c);
};

var Char$is$LChar$LRegExp$S = Char.is$LChar$LRegExp$S;
 ...
 * @return {!boolean}
 */
Char.is$LChar$HBS = function ($this, charclass, c) {
	return $__jsx_ObjectHasOwnProperty.call(charclass, c);
};

var Char$is$LChar$HBS = Char.is$LChar$HBS;
 ...
 * @return {!boolean}
 */
Char.not$LChar$LRegExp$S = function ($this, charclass, c) {
	return ! charclass.test(c);
};

var Char$not$LChar$LRegExp$S = Char.not$LChar$LRegExp$S;
 ...
 * @return {!boolean}
 */
Char.not$LChar$HBS = function ($this, charclass, c) {
	return ! $__jsx_ObjectHasOwnProperty.call(charclass, c);
};

var Char$not$LChar$HBS = Char.not$LChar$HBS;
